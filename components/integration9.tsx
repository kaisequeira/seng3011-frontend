  ...
  return (
    ...
    >
      <div className="container">
        <h1
          data-reveal
          className="mx-auto mb-8 max-w-3xl text-center text-3xl font-semibold"
        >
          {title}
        </h1>
        <div className="grid grid-cols-1 justify-items-center gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {data.map(({ id, icon, title, description }) => (
            <div
              key={id}
              data-card
              className="flex min-h-[140px] w-full max-w-sm flex-col items-start rounded-xl border bg-background p-6 shadow-sm transition hover:shadow-md"
            >
